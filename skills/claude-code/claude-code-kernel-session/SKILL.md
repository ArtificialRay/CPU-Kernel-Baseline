...
- For instruction-level cost when scheduling SVE2/NEON/FP code — or to
  ...
  load/store, BF16):
  - `skills/hardware_docs/neoverse-v2-swog.md` — **Neoverse V2 = Graviton4**, the default
    target. Use this unless told otherwise.
  - `skills/hardware_docs/neoverse-v1-swog.md` — **Neoverse V1 = Graviton3**. Use ONLY when
