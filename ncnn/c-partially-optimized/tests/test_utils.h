// test_utils.h — shared test infrastructure for ncnn c-partially-optimized kernel tests
// All tests are pure C++ with no external dependencies.
#pragma once
#include <cmath>
#include <cstdio>
#include <cstdlib>
...
struct TestMat {
    ...
    void fill_range() { for (int i = 0; i < total(); ++i) data[i] = (float)(i + 1); }
...
// Layer-norm of a flat array in-place
inline void layernorm_inplace(float* p, int n, float eps,
