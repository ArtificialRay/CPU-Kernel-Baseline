...
// Enhanced stub for arm-heavy-optimized tests.
// Provides: Mat::create, Allocator, Layer, ParamDict (functional), ModelBin,
//           ModelBinFromMatArray, Option, cpu helpers, ARM CPU feature stubs,
//           and create_layer_cpu returning real _arm instances.
...
// ── ParamDict ─────────────────────────────────────────────────────────────────
// Functional ParamDict that stores/retrieves int and float values by id.
...
// create_layer_cpu(int) is defined in the test files that include arm headers

// ── CPU helpers ───────────────────────────────────────────────────────────────

int get_cpu_level2_cache_size() { return 512 * 1024; }  // 512 KB default
int get_cpu_level3_cache_size() { return 2 * 1024 * 1024; }  // 2 MB default
...
// Return 1 for features available on aarch64, 0 for SVE (not guaranteed).

int cpu_support_arm_edsp()     { return 1; }
int cpu_support_arm_neon()     { return 1; }
int cpu_support_arm_vfpv4()    { return 1; }
int cpu_support_arm_asimdhp()  { return 1; }
int cpu_support_arm_cpuid()    { return 1; }
int cpu_support_arm_asimddp()  { return 1; }
int cpu_support_arm_asimdfhm() { return 1; }
int cpu_support_arm_bf16()     { return 1; }
int cpu_support_arm_i8mm()     { return 1; }
