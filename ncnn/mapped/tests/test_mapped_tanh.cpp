// test_mapped_tanh.cpp — base vs ARM comparison for TanH
#include "test_utils.h"
#include "ncnn_helpers.h"
#include "../mapped/tanh/tanh.h"
#include "../mapped/tanh/tanh_arm.h"

static bool run_tanh(int c, int h, int w)
{
...
{
    RUN_TEST(test_tanh);
    print_summary("test_mapped_tanh");
    return g_failed ? 1 : 0;
}
