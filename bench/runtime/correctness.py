...
class CorrectnessResult:
    ...
    """Signal-to-quantization-noise ratio (dB); set by compare_sqnr / compare_low_bit,
    else inf (bit-exact / not measured)."""
...
__all__ = ["CorrectnessResult", "compare", "compare_low_bit", "compare_sqnr"]
