...
#
# Tunables (env vars):
#   LOOPS    space-separated loop ids   (default: the 11 scalar-output loops)
...
LOOPS="${LOOPS:-loop_001 loop_002 loop_003 loop_004 loop_008 loop_010 loop_024 loop_032 loop_033 loop_126 loop_127}"
TURNS="${TURNS:-5}"
REPEATS="${REPEATS:-3}"
